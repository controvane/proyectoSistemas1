...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Datos entradas de Medicamentos
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/medicines_transaction/process.php?act=insert" method="POST" id = "formInMed" name="formInMed">
            <div class="box-body">
              ...
              $codigo_transaccion = "TM-$anio-$crear_id";
              ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="fecha_vec" autocomplete="off" value="<?php echo date("d-m-Y"); ?>" required>
                </div>
              </div>
			  ...
			  <!--<div class="form-group">
                ...
                <input type="hidden" name="transaccion" id="transaccion" value="Entrada">
              ...
              <!--<div class="form-group">
                ...
                <input type="hidden" id="total_stok" name="total_stock" value="0">
...
elseif($_GET['form']=='take'){?>
<section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Datos Salida de Medicamentos
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=medicines_transaction"> Entrada </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/medicines_transaction/process.php?act=take" method="POST" id = "formInMed" name="formInMed">
            <div class="box-body">
              <?php  
			  ...
			  <!--<div class="form-group">
                ...
                <input type="hidden" name="transaccion" id="transaccion" value="Salida">
